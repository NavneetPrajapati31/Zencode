...
export default function Profile() {
  ...
  return (
    <div className="h-full flex justify-center items-center px-6 lg:px-10 mb-8">
      {/* Hero Content */}
      <Card className="flex flex-col items-center md:items-start text-center md:text-left w-full p-0 lg:px-0 lg:py-0 rounded-2xl border border-border bg-card transition-all duration-300 theme-transition-override gap-0">
        ...
        <div
          className="w-full grid grid-cols-1 md:grid-cols-4 md:[grid-template-rows:auto_1fr] min-h-[500px] gap-6 !p-8 lg:px-16 lg:py-12"
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col w-full justify-center py-4 px-6">
              ...
              <Button
                variant={"outline"}
                className="text-sm !bg-primary/10 text-primary !border-none"
              >
                View Leaderboard
              </Button>
            </div>
