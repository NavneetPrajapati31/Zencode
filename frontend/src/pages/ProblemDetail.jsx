            ...
            >
              <div className="sticky top-0 z-10 bg-background theme-transition">
                <TabsList className="flex flex-row gap-1 bg-background py-6 px-5 rounded-none theme-transition">
                  <TabsTrigger
                    value="description"
                    className="flex items-center text-muted-foreground rounded-md gap-1 !px-3 !py-4 text-sm font-medium focus-visible:outline-none focus-visible:ring-0 aria-selected:text-accent-foreground aria-selected:border-border cursor-pointer theme-transition transition-colors duration-200 ease-in-out"
