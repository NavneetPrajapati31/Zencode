  ...
  return (
    <div className="p-4 overflow-y-auto">
      ...
      <Tabs defaultValue="description" className="w-full">
        <TabsList className="grid w-full grid-cols-4 bg-zinc-700 text-zinc-300 rounded-md p-1 mb-4">
          <TabsTrigger
            value="description"
        ...
        <TabsContent value="description">
          ...
          <div className="text-zinc-300 leading-relaxed space-y-4 text-sm">
            ...
            <p>
              ...
              <strong className="italic">exactly one solution</strong>, and you
              may not use the{" "}
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-zinc-100 mb-1">Example 1:</h3>
              ...
              <div>
                <h3 className="font-semibold text-zinc-100 mb-1">Example 2:</h3>
                <div className="bg-zinc-700 p-3 rounded-md text-xs">
                  <pre>
                    <code className="block">
                    ...
                    <code className="block">
                      Explanation: Because nums[1] + nums[2] == 6, we return [1,
                      2].
                    </code>
                  </pre>
                </div>
              ...
              <div>
                <h3 className="font-semibold text-zinc-100 mb-1">Example 3:</h3>
                <div className="bg-zinc-700 p-3 rounded-md text-xs">
                  <pre>
                    <code className="block">
        ...
        {/* Other TabsContent for Editorial, Solutions, Submissions would go here */}
      </Tabs>
    </div>
  );
}
